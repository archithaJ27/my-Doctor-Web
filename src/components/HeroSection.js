...
// Uncomment and update this line once your real image is added to src/assets/
    ...
    <section style={styles.heroSection}>
      <div style={styles.heroContent}>
        <h1 style={styles.headline}>
          Join Amrutam – <span style={styles.green}>Grow Your Practice</span>
        </h1>
        <p style={styles.subtitle}>
          Connect with more patients, set your own schedule, and grow your Ayurvedic practice effortlessly with Amrutam.
        </p>
        <a href="#join" style={styles.ctaBtn}>Join Now</a>
        <div style={styles.statsRow}>
          <div style={styles.stat}>
            <strong style={styles.statsNumber}>500+</strong>
            <span style={styles.statsLabel}>Average Active Users</span>
          </div>
          <div style={styles.stat}>
            <strong style={styles.statsNumber}>40+</strong>
            <span style={styles.statsLabel}>Average Daily Free Calls</span>
          </div>
        </div>
      </div>

      <div style={styles.heroImageWrap}>
        {/* Use this placeholder image now to avoid errors */}
        <img 
        ...
        />
        {/* <img src={heroGroup} alt="Group of doctors" style={styles.heroImage} /> */}


        {/* When your image is ready, replace the above <img> tag with: */}
        {/* <img src={heroGroup} alt="Group of doctors" style={styles.heroImage} /> */}
      </div>
    </section>
  );
...
const styles = {
  heroSection: {
    ...
    padding: "60px 6vw 40px 8vw",
    background: "linear-gradient(90deg, #fffdfa 70%, #f0fff2 100%)",
    minHeight: 480,
    gap: "3vw",
    flexWrap: "wrap",
  },
  ...
  heroImage: {
    ...
    maxHeight: 325,
    borderRadius: 20,
    boxShadow: "0 8px 28px #e9eedb",
    background: "#fafefa",
    border: "2.4px solid #ecf8e6",
    objectFit: "cover"
  },
};
